...
input_date_0 = date_input + '-0.csv'
input_date_1 = date_input + '-1.csv'
input_date_2 = date_input + '-2.csv'
...
print(file.loc[file[input_date_0].isin(['Marketable securities',
...
print(file.loc[file[input_date_1].isin(['Revenues',
                                          'Net income',
                                          'Cost of revenues',
                                          'Operating income',
                                          'Income before taxes',
...
print(file.loc[file[input_date_2].isin(['Net income',
                                          'Depreciation',
                                          'Amortization',
                                          'Prepaid expenses',
...
Adjustment_Payments = float(col_one_arr_CSI[6,1])
Net_income = float(col_one_arr_CSI[5,1])
Operating_income = float(col_one_arr_CSI[6,1])
Revenues = float(col_one_arr_CSI[7,1])
#print(col_one_arr_CSI[7,1])
