...
file_1.to_csv('Alphabet-EndingMonths.csv', index=False)
print(len(file_1))
#file_1
...
result.to_csv('2016-06-30-DF-Analysis.csv', index=False)
...
file = pd.read_csv('2016-06-30-DF-Analysis.csv')
#print(file)
...
file_1.to_csv('Dataset.csv', header=None, index=False)
...
file.to_csv('Expected_Close_EV_1.csv', header=None, index=None)
...
file.to_csv('Expected_Close_EBITDA.csv', header=None, index=None)
...
file.to_csv('Expected_Close_EPS.csv', header=None, index=None)
...
file.to_csv('Expected_Close_DIV.csv', header=None, index=None)
...
file.to_csv('Expected_Close_FCF_0.csv', header=None, index=None)
